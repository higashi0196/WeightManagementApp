...
* 自分が作りたいアプリ、サービスに適しているから

【JavaScript】
* 非同期通信機能を実装したかったから
* webアプリの色や文字などに動きを付けたかったので、最適だと感じたから

【MySQL】
* 基礎学習のときに触れる機会があり、使い慣れていたから
...
---
## 使い方
* 体重記入ページで目標体重、現在の体重、日付の新規登録ができます。登録後、自動的に目標体重と現体重の差額がメインページに表示されます。

* 新規登録ページでToDoリスト(タイトル、詳細)を入力でき、また完了したものをチェックすると色が薄くなり線が入り、未完了のものと区別が可能です。

* 画像アップロード画面で画像アップロード、一言メモが入力できます。

* 一言メッセージ画面でコメントを投稿できます。
